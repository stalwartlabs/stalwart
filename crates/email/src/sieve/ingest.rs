...
use sieve::{
    Arena, Context, Envelope, Handler, Input, Mailbox, Recipient, Reply, ScriptArena, Sieve,
    SieveAction, Status,
...
impl<'x> SieveHandler<'x> {
    ...
    fn send_message(&mut self, recipient: Recipient<'_>, message_id: usize) {
        ...
        self.autogenerated.push(AutogeneratedMessage {
            sender_address: self.mail_from.to_string(),
            recipients,
            message: raw_message,
        });
    ...
    fn action(&mut self, _: &Context<'x>, action: SieveAction<'_>) -> Reply<()> {
        match action {
            ...
            SieveAction::SendMessage {
                ...
                self.send_message(recipient, message_id);
            }
