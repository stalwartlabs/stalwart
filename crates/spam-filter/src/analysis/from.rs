...
pub fn analyze_from(ctx: &mut SpamFilterContext<'_>) {
    ...
    if from_count > 0 {
        ...
        if from_name.is_ascii() && from_addr.address.is_ascii() {
            match excess_encoding(from_raw_utf8) {
