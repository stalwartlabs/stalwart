...
impl Key {
    fn code(&self) -> u64 {
        match self {
            ...
            Key::To => 53,
            Key::Total => 54,
            Key::TotalFailures => 55,
            Key::TotalSuccesses => 56,
            Key::Type => 57,
            Key::Uid => 58,
            Key::UidNext => 59,
            Key::UidValidity => 60,
    ...
    fn from_code(code: u64) -> Option<Self> {
        match code {
            ...
            41 => Some(Key::ClientIp),
            42 => Some(Key::RemotePort),
            43 => Some(Key::ReportId),
            44 => Some(Key::Result),
            45 => Some(Key::Size),
            46 => Some(Key::Source),
            47 => Some(Key::SpanId),
            ...
            53 => Some(Key::To),
            54 => Some(Key::Total),
            55 => Some(Key::TotalFailures),
            56 => Some(Key::TotalSuccesses),
            57 => Some(Key::Type),
            58 => Some(Key::Uid),
            59 => Some(Key::UidNext),
            60 => Some(Key::UidValidity),
            61 => Some(Key::Url),
            62 => Some(Key::ValidFrom),
            63 => Some(Key::ValidTo),
            64 => Some(Key::Value),
            65 => Some(Key::Version),
            66 => Some(Key::QueueName),
            _ => None,
        }
    }
}
